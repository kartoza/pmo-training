...
const testplanPatternsBasedTestLoader_1 = require("./testplanPatternsBasedTestLoader");
const testplanJSONBasedTestLoader_1 = require("./testplanJSONBasedTestLoader");
...
class TestplanTestRunner {
    ...
    load(config) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const testLoader = yield this.getTestLoader(testplanConfig);
            ...
            const tests = yield testLoader.parseOutput(result.output);
    ...
    getTestplanArgs(rawTestplanArguments) {
    ...
    getTestLoader(testplanConfig) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return testplanConfig.testplanUseLegacyDiscovery
                ? new testplanPatternsBasedTestLoader_1.TestplanPatternBasedTestLoader()
                : testplanJSONBasedTestLoader_1.TestPlanJSONBasedTestLoader.build(this.logger);
        });
    }
}
